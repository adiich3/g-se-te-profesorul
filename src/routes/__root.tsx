...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Medito · Meditații 1 la 1 în România" },
      {
        name: "description",
        content:
          "Medito te ajută să găsești profesorul potrivit pentru obiectivul tău: Bacalaureat, Evaluare Națională, admitere sau limbi străine.",
      },
      { name: "author", content: "Medito" },
